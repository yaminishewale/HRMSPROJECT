...
namespace HouseRentalManagementApp.Controllers
{
    ...
    public class BookingsController : ControllerBase
    {
        ...
        public async Task<ActionResult<BookingRequest>> PostBooking(BookingRequest booking)
        {
            ...
            {
                return BadRequest(new   { Status = "fail", Message = "House is not available" });
            }
            try
            {
                DateTime d;
                ...
                return Ok(new   { Status = "success", Message = "House booked successfully" });
            }
        ...
        public async Task<IActionResult> DeleteBooking(int id)
        {
            ...
            if (booking == null)
            {
                return BadRequest(new   { Status = "fail", Message = "Booking not found!" });
            }
            var houses = await _context.House.FindAsync(booking.HouseId);
